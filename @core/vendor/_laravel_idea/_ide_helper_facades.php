...
namespace Illuminate\Support\Facades {
     ...
     * @method static mixed whenFilled(string $key, callable $callback)
...
namespace SimpleSoftwareIO\QrCode\Facades {
     ...
     * @method static void color(int $red, int $green, int $blue, int|null $alpha = null)
     * @see \SimpleSoftwareIO\QrCode\Generator::errorCorrection
     * @method static void errorCorrection(string $errorCorrection)
     * @see \SimpleSoftwareIO\QrCode\Generator::backgroundColor
     * @method static void backgroundColor(int $red, int $green, int $blue, int|null $alpha = null)
     ...
     * @method static void merge(string $filepath, float $percentage = .2, bool $absolute = false)
     ...
     * @method static void mergeString(string $content, float $percentage = .2)
     * @see \SimpleSoftwareIO\QrCode\Generator::margin
     * @method static void margin(int $margin)
     * @see \SimpleSoftwareIO\QrCode\Generator::gradient
     * @method static void gradient($startRed, $startGreen, $startBlue, $endRed, $endGreen, $endBlue, string $type)
     ...
     * @method static void encoding(string $encoding)
     ...
     * @method static void eye(string $style)
     ...
     * @method static void size(int $pixels)
     * @see \SimpleSoftwareIO\QrCode\Generator::style
     * @method static void style(string $style, float $size = 0.5)
     * @see \SimpleSoftwareIO\QrCode\Generator::eyeColor
     * @method static void eyeColor(int $eyeNumber, int $innerRed, int $innerGreen, int $innerBlue, int $outterRed = 0, int $outterGreen = 0, int $outterBlue = 0)
...
namespace {
    ...
    class Xgenious extends Xgenious\Api\ApiFacade {}
}